...
var XHRConnection = (function () {
    ...
    function XHRConnection(req, browserXHR, baseResponseOptions) {
        ...
        this.response = new Observable(function (responseObserver) {
            ...
            var onChunkReceived = function () {
                var currentIndex = _xhr.responseText.length;
                if (lastIndex === currentIndex)
                    return;
                var chunkReceived = _xhr.responseText.substring(lastIndex, currentIndex);
...
var RequestOptions = (function () {
    ...
    function RequestOptions(_a) {
        var _b = _a === void 0 ? {} : _a, method = _b.method, headers = _b.headers, body = _b.body, url = _b.url, search = _b.search, params = _b.params, withCredentials = _b.withCredentials, responseType = _b.responseType, chunks$ = _b.chunks$;
...
var Request = (function (_super) {
    ...
    function Request(requestOptions) {
        ...
        _this.chunks$ = requestOptions.chunks$;
        return _this;
    }
    /**
